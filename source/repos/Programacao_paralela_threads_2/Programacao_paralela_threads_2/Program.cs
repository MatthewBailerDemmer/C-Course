...
namespace Programacao_paralela_threads_2
{
    internal class Program
    {
        ...
        public static void MinhaThreadComParametro2(object pParamtroDaThread)
        {
            ParametroDaThread parametroDaThread = (ParametroDaThread) pParamtroDaThread;
        ...
        static void Main(string[] args)
        {
            ...
            Thread t4 = new Thread(()=> MinhaThreadComParametro3(13, "Valéria"));
            t4.Start();
            Console.ReadKey();
            Console.Clear();

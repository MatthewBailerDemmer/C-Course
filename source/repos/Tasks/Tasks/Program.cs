...
namespace Tasks
{
    //Executam uma tarefa em paralelo com o programa principal
    //São temporárias ou seja, quando terminam sua função são extintas
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Task taskImprimeMensagem2 = Task.Run(() => resultadoTask = ImprimeMensagem(10));
            Console.WriteLine("Resultado antes da finalização da nossa task");
            Console.WriteLine("O valor da variável resultadoTask: " + resultadoTask);

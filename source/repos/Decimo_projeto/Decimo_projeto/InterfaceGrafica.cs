...
namespace Oitavo_Projeto
{
    internal class InterfaceGrafica
    {
        ...
        public Resultado_e PegaUInt32(ref UInt32 NumeroDaCasa, string mensagem)
        {
            Resultado_e retorno;
            do
            {
                try
                {
                    ...
                    {
                        NumeroDaCasa = Convert.ToUInt32(temp);
                        retorno = Resultado_e.Sucesso;
                    }
                }
                catch (Exception e)
        ...
        public void ImprimeDadosNaTela(CadastroPessoa pPessoa)
        {
            ...
            Console.WriteLine("Data de nascimento: " + pPessoa.DataDeNascimento.ToString("dd/MM/yyyy"));
        ...
        public Resultado_e CadastrarUsuario()
        {
            Console.Clear();
            string Nome = "";
            ...
            if (PegaString(ref NomeDaRua, "Digite o nome da rua ou S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
            if (PegaUInt32(ref NumeroDaCasa, "Digite o numero da casa S para sair") == Resultado_e.Sair)
                return Resultado_e.Sair;
        ...
        public void BuscaUsuario()
        {
            ...
            {
                Console.WriteLine("Usuário com documento " + temp + " encontrado(s)");
        ...
        public void RemoveUsuario()
        {
            ...
            if (temp.ToLower() == "s")
                return;
            List<CadastroPessoa> listaDePessoaTemp = baseDeDados.RemovePessoaPorDoc(temp);
            Console.Clear();
            if (listaDePessoaTemp != null)
            {
                Console.WriteLine("Usuário com documento " + temp + " removidos");
                ImprimeDadosNaTela(listaDePessoaTemp);
            }
            else
                Console.WriteLine("Nenhum usuário com o documento " + temp + " foi encontrado");
        ...
        public void IniciaInterface()
        {
            ...
            do
            {
                ...
                Console.WriteLine("Digite D para remover um usuário pelo número do documento");
                ...
                {
                    case "c":
                        if (!baseDeDados.BaseDisponivel())
                            Console.WriteLine("Base Indisponível. Tente novamente em alguns instantes");
                        else
                            CadastrarUsuario();
                        break;
                    case "b":

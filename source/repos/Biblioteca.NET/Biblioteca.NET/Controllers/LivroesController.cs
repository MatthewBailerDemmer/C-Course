...
namespace Biblioteca.NET.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,titulo,autor,dtPublicacao,nrPaginas,categoria")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,titulo,autor,dtPublicacao,nrPaginas,categoria")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
